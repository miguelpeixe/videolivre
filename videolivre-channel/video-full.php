				...
				<ul class="video-widgets">
					<li class="video-widget program-color-border">
						<ul class="buttons clearfix">
							<li>
								<span class="big-icon icon heart" title="<?php _e('Social share', 'videolivre-channel'); ?>"><?php $shares = vl_get_the_shares($post->ID); echo $shares['total']; ?></span>
							</li>
							<li>
					...
					<li class="video-widget program-color-border">
						<ul class="icon-list">
							<li class="eye views"><?php vl_the_views(); echo ' '; _e('views', 'videolivre-channel'); ?></li>
							<?php the_tags('<li class="tag tags">', ', ', '</li>'); ?>
						</ul>
					</li>
					<?php
					$attachments = vl_get_the_attachments();
					if($attachments) : ?>
						<li class="video-widget program-color-border">
							<ul class="icon-list">
